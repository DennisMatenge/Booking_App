...
const handleSearch = () =>{
  ...
  return (
    <div className='header'>
        ...
        { type !== "list" &&
        <><h1 className='headerTitle'>Where Discount Matters To You</h1>
        <p className='headerDesc'> Get rewarded for your travels and stand a chance to win instant prizes</p>
